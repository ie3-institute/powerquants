...
import edu.ie3.quants.space.Acres
...
object PoundsPerAcre extends AreaDensityUnit with UnitConverter {
  ...
  // Base unit is kg/m^2
  import edu.ie3.quants.mass.MassConversions.{ pound, kilogram }
  import edu.ie3.quants.space.AreaConversions.{ acre, squareMeter }
