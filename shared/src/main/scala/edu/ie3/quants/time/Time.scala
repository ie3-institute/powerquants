...
import edu.ie3.quants.space.Area
import edu.ie3.quants.radio.{ AreaTime, SquareMeterSeconds }
...
final class Time private (val value: Double, val unit: TimeUnit)
  ...
  def *[A <: edu.ie3.quants.Quantity[A] with edu.ie3.quants.time.TimeIntegral[_]](that: TimeDerivative[A]): A = that * this
