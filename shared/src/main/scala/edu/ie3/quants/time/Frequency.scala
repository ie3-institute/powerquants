...
import edu.ie3.quants.electro.{ ElectricCharge, ElectricPotential, MagneticFlux }
import edu.ie3.quants.information.{ DataRate, Information }
import edu.ie3.quants.motion.{ AngularVelocity, Pressure, PressureChange, Yank }
import edu.ie3.quants.photo.{ Illuminance, LuminousEnergy, LuminousExposure, LuminousFlux }
