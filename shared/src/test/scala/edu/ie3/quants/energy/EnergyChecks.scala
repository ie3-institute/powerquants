...
import edu.ie3.quants.electro.{ Amperes, Coulombs, Volts }
import edu.ie3.quants.mass.Kilograms
import edu.ie3.quants.motion.Newtons
...
import edu.ie3.quants.electro.ElectricPotential
import edu.ie3.quants.electro.ElectricCharge
import edu.ie3.quants.thermal.ThermalCapacity
