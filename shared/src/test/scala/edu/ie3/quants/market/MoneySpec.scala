...
import edu.ie3.quants.QuantityParseException
...
class MoneySpec extends AnyFlatSpec with Matchers with TryValues {
  ...
  it should "provide implicit conversion from Double" in {
    ...
    d.XAU should be(Money(d, edu.ie3.quants.market.XAU))
    d.USD should be(Money(d, edu.ie3.quants.market.USD))
    d.dollars should be(Money(d, edu.ie3.quants.market.USD))
    d.cents should be(Money(d / 100d, edu.ie3.quants.market.USD))
    d.EUR should be(Money(d, edu.ie3.quants.market.EUR))
    d.euros should be(Money(d, edu.ie3.quants.market.EUR))
    d.JPY should be(Money(d, edu.ie3.quants.market.JPY))
    d.yen should be(Money(d, edu.ie3.quants.market.JPY))
    d.GBP should be(Money(d, edu.ie3.quants.market.GBP))
    d.poundSterling should be(Money(d, edu.ie3.quants.market.GBP))
    d.CHF should be(Money(d, edu.ie3.quants.market.CHF))
    d.swissFrancs should be(Money(d, edu.ie3.quants.market.CHF))
    d.AUD should be(Money(d, edu.ie3.quants.market.AUD))
    d.CAD should be(Money(d, edu.ie3.quants.market.CAD))
    d.SEK should be(Money(d, edu.ie3.quants.market.SEK))
    d.NOK should be(Money(d, edu.ie3.quants.market.NOK))
    d.NZD should be(Money(d, edu.ie3.quants.market.NZD))
    d.BTC should be(Money(d, edu.ie3.quants.market.BTC))
    d.bitcoin should be(BTC(d))
    d.ETH should be(Money(d, edu.ie3.quants.market.ETH))
    d.ether should be(ETH(d))
    d.LTC should be(Money(d, edu.ie3.quants.market.LTC))
    ...
    d.satang should be(Money(d / 100d, edu.ie3.quants.market.THB))
  }
